        ...
        <div class="grid grid-cols-2 gap-x-12 gap-y-6">
          ...
          <div>
            ...
            <div class="flex flex-col gap-3">
              ...
              <a href="mailto:selectcivilgroupvic@outlook.com" class="text-gray-400 text-sm hover:text-brand-500 break-words" style="transition: color 0.2s ease;">selectcivilgroupvic@outlook.com</a>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid lg:grid-cols-2 gap-12 lg:gap-20">
          <div>
            ...
            <p class="body-text text-lg mb-8">Tell us about your {s['contact_body_extra']} and we will get back to you within 24 hours. Fill out the form, call us on <a href="tel:0483092615" class="text-brand-500 font-medium hover:underline">0483 092 615</a>, or email <a href="mailto:selectcivilgroupvic@outlook.com" class="text-brand-500 font-medium hover:underline">selectcivilgroupvic@outlook.com</a></p>
            <div class="space-y-5">
              ...
              <div class="border-l-2 border-white/10 pl-5"><p class="text-white text-sm font-bold">Email</p><a href="mailto:selectcivilgroupvic@outlook.com" class="text-gray-400 text-sm hover:text-brand-500" style="transition: color 0.2s ease;">selectcivilgroupvic@outlook.com</a></div>
